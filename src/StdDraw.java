...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static void init() {
        ...
        frame.setTitle("Domi'Nations");
        String crownImage = GuiInitJeu.class.getProtectionDomain().getCodeSource().getLocation().getPath() + File.separator +".." +File.separator+ "crown.png";
        ImageIcon img = new ImageIcon(crownImage);
